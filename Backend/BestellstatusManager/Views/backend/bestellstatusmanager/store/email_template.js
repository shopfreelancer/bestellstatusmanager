...
Ext.define('Shopware.apps.Bestellstatusmanager.store.EmailTemplate', {
    extend : 'Ext.data.Store',

    autoLoad : true,

    model : 'Shopware.apps.Bestellstatusmanager.model.EmailTemplate',
    /**
    ...
    proxy : {
        type : 'ajax',
        api : {
            read : '{url action=getEmailtemplates}',
        },
