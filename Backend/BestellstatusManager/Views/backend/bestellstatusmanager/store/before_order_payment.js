...
Ext.define('Shopware.apps.Bestellstatusmanager.store.BeforeOrderPayment', {
    extend : 'Ext.data.Store',

    autoLoad : true,
	

    model : 'Shopware.apps.Bestellstatusmanager.model.BeforeOrderPayment',
    /**
    ...
    proxy : {
        type : 'ajax',
        api : {
            read    : '{url action=getPaymentStates}',
        },
