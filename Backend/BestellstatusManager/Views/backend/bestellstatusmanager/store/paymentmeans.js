...
Ext.define('Shopware.apps.Bestellstatusmanager.store.Paymentmeans', {
    extend : 'Ext.data.Store',

    autoLoad : true,
	

    model : 'Shopware.apps.Bestellstatusmanager.model.Paymentmeans',
    /**
    ...
    proxy : {
        type : 'ajax',
        api : {
            read    : '{url action=getPaymentmeans}',
        },
